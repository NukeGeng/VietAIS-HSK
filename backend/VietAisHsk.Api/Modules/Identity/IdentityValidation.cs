...
public static class IdentityValidation
{
    ...
    public static string? ValidateProfile(UpdateLearnerProfileRequest request)
    {
        ...
        if (request.StudyPreferences?.PreferredStudyTime is { } studyTime
            && !TimeOnly.TryParseExact(studyTime, "HH:mm", System.Globalization.CultureInfo.InvariantCulture,
                System.Globalization.DateTimeStyles.None, out _))
        {
            return "PreferredStudyTime phải có định dạng HH:mm (00:00–23:59).";
        }
